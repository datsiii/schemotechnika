...
task test_top_2;
    output reg [7:0] test_register;
begin
     $display("\nСценарий 2. Обычное деление без ошибок");
    test_script(
        .a(4'h14), .b(4'h2), .c(4'h1), .d(4'h2),
        .res_expected(1), 
        .error_expected(0), 
        .test_register(test_register)
    );      
