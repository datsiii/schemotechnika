...
begin
    ...
    begin
        ...
        real_sin_res_bit = $realtobis(real_sin_res);
        real_sin_out = $rtoi(real_sin(real_sin_i) * 2.0**(real_sin_exp - 1023 + 15));
        #10;
        real_sin_i = real_sin_i + 3.14159265/180;
    end 
...
begin
    ...
    begin
        ...
        real_cos_res_bit = $realtobis(real_cos_res);
        real_cos_out = $rtoi(real_cos(real_cos_i) * 2.0**(real_cos_exp - 1023 + 15));
        #10;
        real_cos_i = real_cos_i + 3.14159265/180;
    end 
